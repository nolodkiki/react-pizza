...
import { addPizzaItem, minusPizzaItem, removePazzaItem } from "../../Redux/Slices/cartSlice"

const CartItem = ({id, title, price, imageUrl, sizes, types, count}) => {
    const dispatch = useDispatch()
    const onClickPlus = () => {dispatch(addPizzaItem({id}))}
    const onCliclMinus = () => {dispatch(minusPizzaItem({id}))}
    const removeItem = () => {dispatch(removePazzaItem({id}))}
    ...
    return (
        <div className="cart__item">
            ...
            <div className="cart__item-count">
                <div onClick={onCliclMinus} className="button button--outline button--circle cart__item-count-minus">
